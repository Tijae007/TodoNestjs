...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ description: 'To add new task to the user email', summary: 'Add a new task.' }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiOperation)({ description: 'To get a specific user tasks.', summary: 'To get a user tasks.' }),
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiOperation)({ description: 'To update a specific user tasks.', summary: 'To update a user tasks.' }),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiOperation)({ description: 'To delete a specific user tasks.', summary: 'To delete a user tasks.' }),
